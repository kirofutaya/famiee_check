          ...
          <!-- row1 -->
            ...
            <!-- <div class="row">
              <div class="col-md-4 col-md-offset-4" style="text-align:center;padding:50px 0">
                  <a href="https://www.famiee.com/documents/famiee証明書受け入れお願いご提案書.pdf" target="_blank" class="btn btn-danger btn-fill" style="font-size:18px; padding:10px 50px">証明書受け入れお願いご提案書はこちら</a>
              </div> -->
