          ...
          <div class="row">
              <div class="title-area">
                  ...
                  <div class="slide-area">
                    <iframe src="http://www.slideshare.net/slideshow/embed_code/key/tfU8ljz7uFFztv" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe>
                  </div>
                   <div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/OECD-GOV/keynote-presentation-mr-henk-ovink-special-envoy-international-water-affairs-government-of-the-netherlands" title="Keynote presentation: Mr. Henk Ovink, Special Envoy International Water Affairs, Government of the Netherlands" target="_blank">Keynote presentation: Mr. Henk Ovink, Special Envoy International Water Affairs, Government of the Netherlands</a> </strong> from <strong><a href="https://www.slideshare.net/OECD-GOV" target="_blank">OECD Governance</a></strong> </div>
              </div>
          </div>
...
<!-- 動画セクション -->
    <div class="section section-movie">
        <div class="container">
          <div class="row">
              <div class="title-area">
                  <h2 id="movie-top" style="text-align:center">動画説明</h2>
                  <div class="separator separator-danger">✻</div>
              </div>
          </div>

          <div class="flex movie-area">
            <!-- 動画枠 -->
            ...
            <!-- タイトルリスト枠 -->
            <div class="movie-nav"　id="movie-nav">
              <ul id="title-list">
                <!-- additional.jsで中身を生成（<li><a>動画タイトル</a></li>） -->
              </ul>
            </div>
