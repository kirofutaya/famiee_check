  ...
  <div class="container">
    ...
    <div class="k-tl">
      <a href="../project" class="process">
        ...
        <div class="k-tl-area">
          <div class="k-tl-title">STEP1 プロジェクトの説明</div>
      ...
      <a href="../services" class="process">
        <div class="k-tl-marker"></div>
        <div class="k-tl-area">
          <div class="k-tl-title">STEP2 証明書の説明</div>
          <div class="k-tl-content">
      ...
      <a href="https://forms.gle/ib6MmkULt2euknhEA" target="_blank">
        <div class="k-tl-marker active"></div>
        <div class="k-tl-area">
          <div class="k-tl-title active"><span>NEXT</span> 賛同＆受入通知の記入</div>
          <div class="k-tl-content">
