...
" target="_blank"><i class="fa fa-twitter"></i> Twitter</a>
        ...
        <div class="container">
            ...
            <div class="nav nav-text">
                <div class="tab-pane" id="testimonial3">
                    <p class="description"> 「家族」という概念は、近年、とても多様化してきています。LGBTのカップル、事実婚のカップル、精子・卵子提供を受けてできた親子、代理母の協力でできた親子、互いに支え合って生活するシングルマザー同士など、従来の概念での「夫婦」「親子」「家族」に当てはまらない新しいカタチの家族の形態が生まれてきています。
    ...
    <div class="section section-small section-get-started">
        <div class="parallax filter">
            ...
            <div class="container">
                <div class="title-area">
                    <h2 class="text-white">賛同企業募集中！</h2>
                    <div class="separator line-separator">♦</div>
