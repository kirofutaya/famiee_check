          ...
          <div class="row">
              <div class="title-area">
                  ...
                  <div class="slide-area">
                    <iframe src="//www.slideshare.net/slideshow/embed_code/key/nfkgOcp48a43TB" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe>
                  </div>
                   <div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/secret/nfkgOcp48a43TB" title="20200425Famieeパートナーシップ証明書説明資料" target="_blank">Famieeパートナーシップ証明書説明資料（2020/04/25更新）</a></strong></div>
              </div>
          </div>
...
<div class="section section-movie">
  <div class="container">
  <div class="title-area" style="">
      <h3>他の説明もご用意しております</h3>
      <div class="separator separator-danger">✻</div>
  </div>

  <div class="flex" style="margin:auto; margin-top:30px; width:80%">
